...
public class InvoiceDetails {
 ...
 public void setBusinessYear(String buisness_year ) {
...
public String toString() {
 String res = business_code + ", " + cust_number + ", " + name_customer + ", " + clear_date + ", " + buisness_year + ", " + doc_id + ", " + posting_date + ", " + document_create_date + ", " + due_in_date + ", " + invoice_currency + ", " + document_type + ", " + posting_id + ", " + total_open_amount + ", " + baseline_create_date + ", " + cust_payment_terms + ", " + invoice_id + ", " + isOpen + "\n";
